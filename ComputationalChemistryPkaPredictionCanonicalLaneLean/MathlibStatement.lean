...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "computational-chemistry-pka-prediction-canonical-lane",
  theoremObject := "Pka prediction closure under admissible class",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedPkaPredictionClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_pka_prediction_endgame A
